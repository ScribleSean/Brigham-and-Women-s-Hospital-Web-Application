...
function Credits() {
  const tools = [
      {
          description: "GitHub: is a tool used by developers that allows for developers to collaborate and work on different portions" +
      ...
      },
      {
          ...
          image: './public/NodeJSLogo.png',
      },
      {
          description: "Yarn: is one of the main JavaScript package managers, developed in 2016 by Sebastian McKenzie of Meta" +
              "for the Node.js JavaScript runtime environment. Link: https://yarnpkg.com/",
          image: './public/YarnLogo.png',
      },
      {
          description: "Prettier: is a tool to format files in various languages, like TypeScript, JavaScript, CSS, HTML, JSON, and others." +
                  "With WebStorm, you can format selected code fragments as well as entire files or directories using the Reformat with" +
              "Prettier action.",
          image: './public/PrettierLogo.png',
      },
      {
          description: "Jtest: is an automated Java software testing and static analysis product developed by Parasoft. The product includes" +
          ...
          image: './public/VitestLogo.png',
      },
      {
          description: "Auth0: provides authentication and authorization as a service. We are here to give developers and companies the" +
              "building blocks they need to secure their applications without having to become security experts.",
          image: './public/Auth0Logo.png',
      },
      {
          description: "Prisma: A database tool used to simplify the database development process by providing automated mitigations "+
              "and mapping layers, as well as a visual data management interface.",
          image: './public/PrismaLogo.png',
      },
  ];
    ...
    const libraries = [
        {
            ...
            image: './public/ReactLogo.png', // Example path, replace with actual image path
        },
        {
            description: "Material UI is an open-source React component library that implements Google's " +
                "Material Design. It's comprehensive and can be used in production out of the box.",
            image: './public/MaterialUILogo.png', // Example path, replace with actual image path
        },
        {
            description: "Axios is a promise-based HTTP Client for node.js and the browser. It " +
                "is isomorphic, using the native node.js http module on the server-side, and " +
                "XMLHttpRequests on the client.",
            image: './public/axiosLogo.png', // Example path, replace with actual image path
        },
    ];
  const frameworks = [
      {
      ...
      {
          description: "Express, a back end web application framework for Node.js.",
          image: './public/expressLogo.png', // Example path, replace with actual image path
      },
  ];
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <img src={tools[currentIndexTool].image}
                                 alt="Tool Image"
                      ...
                      <Box sx={{
                          ...
                          <img src={libraries[currentIndexLib].image} alt="Library Image"
                               style={{width: '100%', maxHeight: '200px', objectFit: 'contain'}}/>
                          ...
                          <div style={{marginTop: "20px"}}>
                              ...
                              <ArrowBackIcon style={{cursor: "pointer"}} onClick={previousLibrary}/>
                              <ArrowForwardIcon style={{cursor: "pointer"}} onClick={nextLibrary}/>
                          </div>
                      </Box>
                      {/* Frameworks Section */}
                      <Box sx={{
                          ...
                          <img src={frameworks[currentIndexFrame].image} alt="Framework Image"
                               style={{width: '100%', maxHeight: '200px', objectFit: 'contain'}}/>
                          ...
                          <div style={{marginTop: "20px"}}>
                              ...
                              <ArrowBackIcon style={{cursor: "pointer"}} onClick={previousFramework}/>
                              <ArrowForwardIcon style={{cursor: "pointer"}} onClick={nextFramework}/>
                          </div>
                      </Box>
                  </Box>
              </Box>
