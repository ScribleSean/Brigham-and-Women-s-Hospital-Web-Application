...
import {
    ...
    DeleteNodesOptionsRequest, NodeWithAssociatedEdges, OldNewEdge,
    OldNewNode, RefactorEdgesOptionsRequest,
    ...
    return (
        <>
            ...
            <Dialog open={dialogueOpen} onClose={() => setDialogueOpen(false)}>
                ...
                <DialogContent>
                    <DialogContentText>
                        This will apply all the changes made in the map locations and connections. This
